...
class User(db.Model):
    ...
    img_url = db.Column(db.Text, default="/static/images/user-images/default-pic.png")
...
class Tool(db.Model):
    ...
    img_url = db.Column(
        db.Text,
        default="/static/images/user-images/default-pic.png")
    ...
    owner = db.relationship('User', backref=backref("tools", cascade="all,delete"), foreign_keys=[owner_id])
    renter = db.relationship('User', backref="rents", foreign_keys=[renter_id])